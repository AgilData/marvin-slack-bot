...
class RtmBot(object):
    ...
    def load_plugins(self):
        ...
        for plugin in glob.glob(directory+'/plugins/*.py') + glob.glob(directory+'/plugins/*/*.py'):
            ...
            self.bot_plugins.append(Plugin(name, self.slack_client))


class Plugin(object):
    def __init__(self, name, slack_client, plugin_config={}):
        self.name = name
        ...
        if 'setup' in dir(self.module):
            self.module.setup(slack_client)
    ...
    def do(self, function_name, data):
        if function_name in dir(self.module):
            ...
            if not debug:
                try:
                    eval("self.module."+function_name)(data, self.slack_client)
                except:
...
if __name__ == "__main__":
    ...
    config = yaml.load(file(args.config or 'marvin.conf', 'r'))
    debug = config["DEBUG"]
